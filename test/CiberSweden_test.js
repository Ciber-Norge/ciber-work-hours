...
var workHours = require('../')('se');

describe('Ciber Sweden', function () {
    ...
    it('International Workers\' Day is a public holiday', function () {
    ...
    it('National Day of Sweden is a public holiday', function () {
        workHours.calculate(new Date(2014, 5, 6)).should.equal(0);
        workHours.calculate(new Date(2015, 5, 6)).should.equal(0);
        workHours.calculate(new Date(2016, 5, 6)).should.equal(0);
    });
    ...
    it('Midsummer Eve is a de facto holiday', function () {
    ...
    it('Christmas Eve is a de facto holiday', function () {
    ...
    it('New Year\'s Eve is a de facto holiday', function () {
        workHours.calculate(new Date(2017, 11, 31)).should.equal(0);
        workHours.calculate(new Date(2018, 11, 31)).should.equal(0);
        workHours.calculate(new Date(2019, 11, 31)).should.equal(0);
    });
